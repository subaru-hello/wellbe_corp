<template>
  ...
  >
    ...
    <div class="hero-content text-center text-neutral-content">
      <div class="max-w-md">
        <h1 class="mb-5 text-5xl font-bold">{{ greeting }}</h1>
        <p class="mb-5">WellBeingを追求するエンジニアのサイト</p>
        <button class="btn btn-primary">WellBeeって何？</button>
      </div>
    </div>
  </div>
  <div class="text-white bg-gray-900">
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
      <div class="max-w-lg mx-auto text-center">
        <h2 class="text-3xl font-bold sm:text-4xl">幸せの物差しを増やす</h2>

        <p class="mt-4 text-gray-300">
          人生における幸せの形って様々。好きな車や家に住んで豪遊すること。家族を幸せにすること。陸上をすること。登山、キャンプ、サーフィン、宇宙探索。
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <h3 class="mt-4 text-xl font-bold text-white">家族と過ごす</h3>
        ...
        >
          ...
          <h3 class="mt-4 text-xl font-bold text-white">秘境をめぐる</h3>
      ...
      <div class="mt-12 text-center">
        <a
          ...
          href="/get-started"
        >
          <span class="text-sm font-medium"> WellBeを覗く</span>
